    ...
    <div className={styles.hero_container} id="Hero">
      ...
      <div className={styles.title_container}>
        <h1 className={styles.hero_title}>
          <span className={styles.title1}>Hello. I&apos;m Arda</span>
          <span className={styles.title2}>Software Engineer</span>
        </h1>
        <p className={styles.desc}>
          Passionate about learning and creating with the latest technologies, I
